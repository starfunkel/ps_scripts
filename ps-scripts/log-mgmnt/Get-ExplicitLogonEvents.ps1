function Get-ExplicitLogonEvents {
    ...
    Get-WinEvent -FilterHashtable @{LogName='Security'; Id=4625; StartTime=(Get-Date).AddDays(-$Days)} | 
    ...
    Select-object TimeCreated,TargetUser,ProcessName,ProcessId,SubjectUser,SubjectDomainName | ConvertTo-Csv -NoTypeInformation
}
