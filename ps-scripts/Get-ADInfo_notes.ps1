...
Netzwerk :
        ...
        Get-DhcpServerv4Lease -ComputerName ..... -ScopeID 10.10.0.0

        alle reservicerungen

        Get-DhcpServerv4Reservation -ComputerName .... -ScopeID 10.10.0.0

get all connected users of a network printShareName

Get-WmiObject Win32_ServerConnection -ComputerName .... | Select-Object ShareName,UserName,ComputerName | Where-Object {$_.ShareName -eq "xxx"}