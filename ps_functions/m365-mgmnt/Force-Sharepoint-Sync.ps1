function Force-Sharepoint-Sync {
    ...
    Do{
        ...
        If ($ODStatus) 
        {
            ...
            $odopen = "odopen://sync/?siteId=" + $SiteID + "&webId=" + $WebID + "&webUrl=" + $webURL + $SiteName `
            + "&listId=" + $ListID + "&userEmail=" + $UserName + $Domain + "&webTitle=" + $SiteName + ""
