...
# Get all SMBClient Connectivity events within the date range
...
if ($Events.Count -eq 0) {
    Write-Host "No SMBClient Connectivity events found in the last 2 days."
} else {
    ...
    $OutputFile = "D:\SMBClientEvents.xlsx"
    ...
    # Final message
    Write-Host "SMBClient Connectivity events from the last days have been exported to $OutputFile"
}
